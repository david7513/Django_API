...
urlpatterns = [
    path('students/<str:name>/', StudentViewSet.as_view({'get': 'search_by_name'}), name='student-search-by-name'),
    path('', include(router.urls)), # Inclure les URLs générées par le routeur
]
